...
json_handler = logging.FileHandler('app2-json.log')
json_handler.setFormatter(JSONFormatter())
logger.addHandler(json_handler)

app = FastAPI(title="Application 2", description="Simple Application Number 1")

logger.info("Application 2 starting up...")
...
REQUEST_LATENCY = Histogram(
    'app2_request_latency_seconds', 
    'app2 Request latency',
    ['endpoint']
)
ACTIVE_USERS = Gauge('app2_active_users', 'app2 Active Users')
ENDPOINT_HITS = Counter('app2_endpoint_hits', 'app2 Endpoint Hits', ['endpoint'])
...
if __name__ == "__main__":
    logger.info("Starting uvicorn server on port 5002")
