...
json_handler = logging.FileHandler('app4-json.log')
json_handler.setFormatter(JSONFormatter())
logger.addHandler(json_handler)

app = FastAPI(title="Application 4", description="Simple Application Number 1")

logger.info("Application 4 starting up...")
...
REQUEST_LATENCY = Histogram(
    'app4_request_latency_seconds', 
    'app4 Request latency',
    ['endpoint']
)
ACTIVE_USERS = Gauge('app4_active_users', 'app4 Active Users')
ENDPOINT_HITS = Counter('app4_endpoint_hits', 'app4 Endpoint Hits', ['endpoint'])
...
if __name__ == "__main__":
    logger.info("Starting uvicorn server on port 5004")
