...
json_handler = logging.FileHandler('app5-json.log')
json_handler.setFormatter(JSONFormatter())
logger.addHandler(json_handler)

app = FastAPI(title="Application 5", description="Simple Application Number 1")

logger.info("Application 5 starting up...")
...
REQUEST_LATENCY = Histogram(
    'app5_request_latency_seconds', 
    'app5 Request latency',
    ['endpoint']
)
ACTIVE_USERS = Gauge('app5_active_users', 'app5 Active Users')
ENDPOINT_HITS = Counter('app5_endpoint_hits', 'app5 Endpoint Hits', ['endpoint'])
...
if __name__ == "__main__":
    logger.info("Starting uvicorn server on port 5005")
