...
logger.info("Application 1 starting up...")
...
REQUEST_LATENCY = Histogram(
    'app1_request_latency_seconds', 
    'App1 Request latency',
    ['endpoint']
)
ACTIVE_USERS = Gauge('app1_active_users', 'App1 Active Users')
ENDPOINT_HITS = Counter('app1_endpoint_hits', 'App1 Endpoint Hits', ['endpoint'])
...
if __name__ == "__main__":
    logger.info("Starting uvicorn server on port 5001")
